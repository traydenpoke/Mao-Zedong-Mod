...
VALUES	('CIVILIZATION_TEMP_CIV_CUSTOM',	'LEADER_TEMP_LEADER_CUSTOM',	'BUILDING_TEMP_CUSTOM',	'ICON_BUILDING_GREAT_WALL',	'LOC_BUILDING_TEMP_CUSTOM_NAME',			'LOC_BUILDING_TEMP_CUSTOM_DESCRIPTION',				30),
		('CIVILIZATION_TEMP_CIV_CUSTOM',	'LEADER_TEMP_LEADER_CUSTOM',	'UNIT_TEMP_CUSTOM_I',	'ICON_UNIT_CHINESE_CROUCHING_TIGER',		'LOC_UNIT_TEMP_CUSTOM_I_NAME',				'LOC_UNIT_TEMP_CUSTOM_I_DESCRIPTION',				20),
		('CIVILIZATION_TEMP_CIV_CUSTOM',	'LEADER_TEMP_LEADER_CUSTOM',	'UNIT_TEMP_CUSTOM_II',	'ICON_UNIT_TEMP_CUSTOM_II',		'LOC_UNIT_TEMP_CUSTOM_II_NAME',				'LOC_UNIT_TEMP_CUSTOM_II_DESCRIPTION',				10);
